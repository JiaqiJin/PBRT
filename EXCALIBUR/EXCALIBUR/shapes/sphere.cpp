...
Interaction Sphere::sampleW(const Rendering::Interaction& ref, const Point2f& u, Float* pdf) const {
    Interaction ret;
...
Float Sphere::pdfW(const Rendering::Interaction& ref, const Vector3f& wi) const {
    Point3f pCenter = objectToWorld->exec(Point3f(0, 0, 0));
